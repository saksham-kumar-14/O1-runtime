...
- Bind Mount/Volumes: allow to map folder from host directly into the container
  - *Concurrency Race condition:* 
    - Doing a light task such as writing string to a next file takes way less time than my host go process to create virtual ethernet cable, attach it to bridge and call `nsenter` to inject it to the container
